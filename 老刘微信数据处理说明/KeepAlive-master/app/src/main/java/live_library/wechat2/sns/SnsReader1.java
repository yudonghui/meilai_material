...
public class SnsReader1 {
    ...
    public SnsReader1(Class SnsDetail, Class SnsDetailParser, Class SnsObject){
    ...
    public void run() throws Throwable {
        ...
        queryDatabase();
        Task1.saveToJSONFile(this.snsList, Config.EXT_DIR + "/all_sns.json", false);
    }
...
//        String dbPath = Config.EXT_DIR + "/SnsMicroMsg.db";
        ...
        String dbPath = SqlDataUtil1.WX_DB_DIR_PATH() + userFileName +"/" + SqlDataUtil1.WX_DB_FILE_NAME_sns;
