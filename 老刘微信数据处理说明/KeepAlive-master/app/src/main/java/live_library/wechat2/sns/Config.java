...
//    final static public String EXT_DIR = Environment.getExternalStorageDirectory() + "/WeChatMomentStat";
    final static public String EXT_DIR = "/data/data/com.mylike.keepalive/";
    final static public String DATA_DIR = Environment.getDataDirectory() + "/data/moe.chionlab.wechatmomentstat";
    final static public String SD_DIR = Environment.getExternalStorageDirectory()+"/tencent/MicroMsg/";
    final static public String SD_DIR_ARM = Environment.getExternalStorageDirectory()+"/Android/data/com.tencent.mm/MicroMsg/";
    final static public String SD_DIR_0_ARM = "/storage/emulated/0/Android/data/com.tencent.mm/MicroMsg/";
    final static public String SD_DIR_1_ARM = "/storage/emulated/999/Android/data/com.tencent.mm/MicroMsg/";
    final static public String SD_DIR_1_ARM_default = "/mnt/runtime/default/emulated/999/Android/data/com.tencent.mm/MicroMsg/";
    final static public String SD_DIR_1_ARM_READ = "/mnt/runtime/read/emulated/999/Android/data/com.tencent.mm/MicroMsg/";
    final static public String SD_WECHAT_PIC_DIR = SD_DIR+"WeiXin/";// /storage/sdcard0/tencent/MicroMsg/WeiXin/mmexport1575732295847.jpg
