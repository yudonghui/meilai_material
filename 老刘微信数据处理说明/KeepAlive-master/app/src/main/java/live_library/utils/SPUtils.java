...
import live_library.pro_sp.PreferenceUtil;
...
//        put(key, value, false);
    ...
    public static void init(Context context) {
        if (mPreferences == null)
            mPreferences = PreferenceUtil.getSharedPreference(context, "DEV_MYLIKE");
    }
